...
public class MyGLScene extends LeGLBaseScene {
    ...
    private void initUI() {
         ...
         */
        // 加载obj文件
        ObjData objData = ObjParser.loadObj("camaro.obj", this.getResources());
        // 构建3D物体对象
    ...
    public boolean onTouchEvent(MotionEvent e) {
        ...
        switch (e.getAction()) {
            case MotionEvent.ACTION_MOVE:
                ...
                float yAngle = mLeGLObjSpirit.getSpriteAngleY();
                mLeGLObjSpirit.setSpriteAngleY(yAngle += dx * TOUCH_SCALE_FACTOR);
